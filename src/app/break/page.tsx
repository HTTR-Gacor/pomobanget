...
export default function Break() {
  ...
  return (
    <div className={`${isStarted && !isPaused ? 'bg-warnahajik' : 'bg-[#4682B4]'} flex flex-col justify-center items-center py-20 h-screen transition-all duration-500`}>
        <Link href="/" className="px-8 py-4 my-3 drop-shadow-xl rounded-xl bg-primary text-secondary font-bold text-3xl">
        Work
      </Link>
      <h1 className="text-3xl drop-shadow-md text-secondary">
